...
const headCells: HeadCell[] = [
  ...
  { id: 'descripcion', label: 'Dirección Completa', numeric: false, width: '400px' },
  { id: 'rutaNombre', label: 'Ruta', numeric: false, width: '120px' },
  { id: 'zonaNombre', label: 'Zona', numeric: false, width: '120px' },
  { id: 'ubicacionAreaVerdeNombre', label: 'Ubicación Área Verde', numeric: false, width: '180px' },
  ...
  const filteredDirecciones = useMemo(() => {
    ...
    if (localSearchTerm) {
      ...
      result = result.filter(direccion => 
        ...
        direccion.ubicacionAreaVerdeNombre?.toLowerCase().includes(searchLower) ||
                ...
                {headCells.map((headCell) => (
                  <TableCell
                    ...
                    align={
                      ...
                      headCell.id === 'ubicacionAreaVerdeNombre' ? 'left' :
                    ...
                    sx={(theme) => ({ 
                      ...
                      padding: 
                        ...
                        headCell.id === 'rutaNombre' || headCell.id === 'zonaNombre' || headCell.id === 'ubicacionAreaVerdeNombre' ? '4px 8px' : '8px 16px',
