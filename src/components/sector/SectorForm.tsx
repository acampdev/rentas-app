...
const SectorForm: React.FC<SectorFormProps> = ({
  ...
  useEffect(() => {
    if (sectorSeleccionado) {
      ...
      setValue("cuadrante", (sectorSeleccionado.cuadrante as any) || 0);
      setValue("codUnidadUrbana", (sectorSeleccionado.codUnidadUrbana as any) || 0);
