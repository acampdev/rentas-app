...
const menuItems: MenuItem[] = [
  ...
  { /* Caja */
    ...
    icon: <ReceiptIcon />,
    subMenuItems: [
      { id: 'cajas', label: 'Caja Mantenedor', path: '/mantenedores/caja/cajas' },
...
const sistemaMenuItems: MenuItem[] = [
    ...
    subMenuItems: [
      ...
      // Escalas
      {
        ...
        subMenuItems: [
          ...
          { id: 'interes', label: 'Interés', path: '/mantenedores/escalas/interes' },
          
        ]
      },
      { id: 'resolucion-interes-mant', label: 'Resolución Interés', path: '/mantenedores/resolucion-interes' }
    ],
  },
  ...
  /** Personas */
  {
    ...
    subMenuItems: [
      ...
      { id: 'consulta-persona', label: 'Consulta Persona', path: '/persona/consulta' },
    ],
  },
  /** Usuarios */
  {
